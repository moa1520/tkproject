...
class Transformer(nn.Module):
    ...
    def forward(self, src, src_mask, query_embed, pos_embed):
        ...
        query_embed1 = query_embed
        query_embed2 = query_embed[64:, :, :]
        query_embed3 = query_embed[64+32:, :, :]
        query_embed4 = query_embed[64+32+16:, :, :]
        query_embed5 = query_embed[64+32+16+8:, :, :]
        query_embed6 = query_embed[64+32+16+8+4:, :, :]

        src_mask1 = src_mask[:, :64]
        src_mask2 = src_mask[:, 64:64+32]
        src_mask3 = src_mask[:, 64+32:64+32+16]
        src_mask4 = src_mask[:, 64+32+16:64+32+16+8]
        src_mask5 = src_mask[:, 64+32+16+8:64+32+16+8+4]
        src_mask6 = src_mask[:, 64+32+16+8+4:]
